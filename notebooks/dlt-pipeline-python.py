...
# MAGIC %md
# MAGIC ### Synthetic Retail Dataset
# MAGIC 
# MAGIC 
# MAGIC * Sales Orders: **sales_orders/sales_orders.json** records the customers' originating purchase order.
# MAGIC * Customers: **customers/customers.csv** contains those customers who are located in the US and are buying the finished products.
# MAGIC 
# MAGIC see https://github.com/databricks/delta-live-tables-notebooks
